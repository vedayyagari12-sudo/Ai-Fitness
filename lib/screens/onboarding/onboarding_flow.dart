...
class _OnboardingFlowState extends State<OnboardingFlow> {
  ...
  bool get _canContinue {
    switch (_step) {
      ...
      case 6:
        return _data.hearAboutSource != null;
      case 7:
    ...
    switch (_step) {
      ...
      case 6:
        return _SourceStep(
          ...
          selected: _data.hearAboutSource,
          onSelect: (v) => setState(() => _data.hearAboutSource = v),
          onBack: _back,
          onContinue: _canContinue ? _next : null,
        );
      case 7:
...
class _BodyStatsStepState extends State<_BodyStatsStep> {
  ...
  void _sync() {
    ...
    widget.data.weightKg = double.tryParse(_weightCtrl.text);
...
class _SourceStep extends StatelessWidget {
  ...
  static const _sources = [
    ...
    ('Friend or Family', Icons.people_outline),
...
class _InitialPhysiqueScanStepState extends State<_InitialPhysiqueScanStep> {
  ...
  void initState() {
    super.initState();
    _localImagePath = widget.data.initialPhysiqueImagePath;
  }
